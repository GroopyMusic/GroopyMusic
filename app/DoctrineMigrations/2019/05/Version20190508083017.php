 ...
 */
class Version20190508083017 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE yb_custom_tickets ADD previewMode TINYINT(1) NOT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE yb_custom_tickets DROP previewMode');
    }
}
