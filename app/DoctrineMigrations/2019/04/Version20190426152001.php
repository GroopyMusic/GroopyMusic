 ...
 */
class Version20190426152001 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE address CHANGE latitude latitude NUMERIC(15, 10) DEFAULT NULL, CHANGE longitude longitude NUMERIC(15, 10) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE address CHANGE latitude latitude NUMERIC(10, 0) DEFAULT NULL, CHANGE longitude longitude NUMERIC(10, 0) DEFAULT NULL');
    }
}
