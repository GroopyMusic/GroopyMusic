 ...
 */
class Version20190424115240 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE yb_venues_config CHANGE updated_at updated_at DATETIME DEFAULT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE yb_venues_config CHANGE updated_at updated_at DATETIME NOT NULL');
    }
}
