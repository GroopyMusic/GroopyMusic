 ...
 */
class Version20190429073126 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE yb_public_transport_stations CHANGE latitude latitude NUMERIC(15, 10) NOT NULL, CHANGE longitude longitude NUMERIC(15, 10) NOT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE yb_public_transport_stations CHANGE latitude latitude NUMERIC(10, 0) NOT NULL, CHANGE longitude longitude NUMERIC(10, 0) NOT NULL');
    }
}
