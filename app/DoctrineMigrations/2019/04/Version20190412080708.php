 ...
 */
class Version20190412080708 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE yb_reservations DROP cart_id, DROP counterpart_id');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE yb_reservations ADD cart_id INT DEFAULT NULL, ADD counterpart_id INT NOT NULL');
