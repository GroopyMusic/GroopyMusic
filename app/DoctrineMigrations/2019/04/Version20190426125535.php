 ...
 */
class Version20190426125535 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE address ADD latitude NUMERIC(10, 0) DEFAULT NULL, ADD longitude NUMERIC(10, 0) DEFAULT NULL');
    }
