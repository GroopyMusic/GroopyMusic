 ...
 */
class Version20180321124003 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE contract_fan CHANGE ticket_sent counterparts_sent TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE contract_fan CHANGE counterparts_sent ticket_sent TINYINT(1) NOT NULL');
        $this->addSql('ALTER TABLE ticket DROP FOREIGN KEY FK_97A0ADA39A00546E');
        $this->addSql('DROP INDEX IDX_97A0ADA39A00546E ON ticket');
        $this->addSql('ALTER TABLE ticket DROP contract_artist_id, DROP price, DROP validated, DROP name');
